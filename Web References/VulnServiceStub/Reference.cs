...
namespace VulnApp.VulnServiceStub {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="VulnServiceSoap", Namespace="http://tempuri.org/")]
    public partial class VulnService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public VulnService() {
            this.Url = global::VulnApp.Properties.Settings.Default.VulnApp_VulnServiceStub_VulnService;
        ...
        /// <remarks/>
        public void GetScoreAsync(string ID) {
            this.GetScoreAsync(ID, null);
        }
        
        /// <remarks/>
        public void GetScoreAsync(string ID, object userState) {
            ...
            this.InvokeAsync("GetScore", new object[] {
                        ID}, this.GetScoreOperationCompleted, userState);
        }
